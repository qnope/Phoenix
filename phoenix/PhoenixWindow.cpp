...
vk::AttachmentDescription PhoenixWindow::getAttachmentDescription() const
    noexcept {
...
const Framebuffer<vk::ImageView> &PhoenixWindow::getCurrentFramebuffer() const
    noexcept {
  return m_swapchain.getFramebuffer(m_currentImageIndex);
}

const Framebuffer<vk::ImageView> &
PhoenixWindow::getFramebuffer(uint32_t index) const noexcept {
  return m_swapchain.getFramebuffer(index);
}

const std::vector<Framebuffer<vk::ImageView>> &
PhoenixWindow::getFramebuffers() const noexcept {
