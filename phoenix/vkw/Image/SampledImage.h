...
class SampledImageRef {
  public:
    ...
    SampledImageRef(const ImageView<Type, Format, _Usage> &imageView, const Sampler &sampler) noexcept :
        imageView{imageView.getHandle()}, sampler{sampler.getHandle()} {
        static_assert((imageUsage & imageView.imageUsage) == imageUsage, "Usage must corresponds");
    }
...
using SampledImage2dRgbaSrgbRef =
    SampledImageRef<vk::ImageViewType::e2D, vk::Format::eR8G8B8A8Srgb, VK_IMAGE_USAGE_SAMPLED_BIT>;
} // namespace phx
