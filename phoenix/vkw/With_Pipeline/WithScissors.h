...
template <typename... Scissors> class WithScissors {
  static constexpr ltl::type_list_t<Scissors...> scissor_types{};

  static constexpr auto numberDynamicScissors =
      ltl::count_type(scissor_types, ltl::type_v<scissor::DynamicScissor>);
  static constexpr auto numberStaticScissors =
      ltl::count_type(scissor_types, ltl::type_v<scissor::StaticScissor>);
...
private:
  void compileTimeCheck() {
    ...
    typed_static_assert_msg(
        all_of_type(scissor_types, is_derived_from(type_v<scissor::Scissor>)),
