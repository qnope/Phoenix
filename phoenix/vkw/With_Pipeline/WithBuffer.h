...
struct BindingDescription<ltl::number_t<Binding>, ltl::type_t<Type>, AttributeCount> {
    template <typename... Attributes>
    BindingDescription(ltl::number_t<Binding>, ltl::type_t<Type>, uint32_t stride, Attributes... attributes) :
        stride{stride}, //
...
BindingDescription(Binding, Type, uint32_t, Ts...) -> BindingDescription<Binding, Type, sizeof...(Ts)>;

template <typename... Bindings>
struct WithBindingDescriptions;

template <int... Bindings, typename... Types, std::size_t... AttributeCounts>
struct WithBindingDescriptions<BindingDescription<ltl::number_t<Bindings>, ltl::type_t<Types>, AttributeCounts>...> {
    WithBindingDescriptions(
        BindingDescription<ltl::number_t<Bindings>, ltl::type_t<Types>, AttributeCounts>... descriptions) :
        bindings{vk::VertexInputBindingDescription(descriptions.binding.value, descriptions.stride,
...
LTL_MAKE_IS_KIND(WithBindingDescriptions, is_with_binding_descriptions, IsWithBindingDescriptions, typename);
