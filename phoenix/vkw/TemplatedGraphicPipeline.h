...
template <typename... Args> class TemplatedGraphicPipeline;

template <typename... RPs, typename SubpassIndex, typename... Args>
class TemplatedGraphicPipeline<RenderPass<RPs...>, SubpassIndex, Args...>
...
public:
  ...
  TemplatedGraphicPipeline(vk::Device device, PipelineLayout pipelineLayout,
...
LTL_MAKE_IS_KIND(TemplatedGraphicPipeline, is_graphic_pipeline,
                 IsGraphicPipeline, typename);
} // namespace phx
