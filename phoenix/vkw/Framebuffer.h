...
class Framebuffer : public VulkanResource<vk::UniqueFramebuffer> {
    ...
    typed_static_assert_msg(ltl::all_of_type(attachment_types, ltl::is_type(ltl::type_v<vk::ImageView>)),
  ...
  public:
    ...
    Framebuffer(vk::Device device, vk::RenderPass renderPass, uint32_t width, uint32_t height,
        ...
        auto buildArray = [](auto... xs) { return std::array<vk::ImageView, number_attachments.value>{xs...}; };
