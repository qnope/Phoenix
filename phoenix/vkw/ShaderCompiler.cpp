...
namespace detail {
shaderc_include_result *ShaderCompilerIncluder::GetInclude(const char *requested, shaderc_include_type,
...
std::vector<uint32_t> ShaderCompiler::compile(const std::string &path, shaderc_shader_kind kind) const {
