...
class Material {
    struct Concept {
        ...
        virtual void bindTo(vk::CommandBuffer cmdBuffer, const PipelineLayout &pipelineLayout) const noexcept = 0;
    ...
    class Model final : public Concept {
      public:
        ...
        void bindTo(vk::CommandBuffer cmdBuffer, const PipelineLayout &pipelineLayout) const noexcept override {
